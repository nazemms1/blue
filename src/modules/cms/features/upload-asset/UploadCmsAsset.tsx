...
export function UploadCmsAsset({
  ...
  return (
    <Modal opened={opened} onClose={handleClose} title="Upload CMS Asset" centered size="md">
      <Stack gap="md">
        <div
          style={{
        ...
        {uploading && <Progress value={progress} animated size="sm" />}
