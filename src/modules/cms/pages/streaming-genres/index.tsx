...
export function CmsStreamingGenresPage() {
  ...
  const filtered = genres
    .filter((g) => g.contentType === "streaming")
  ...
  return (
    <Stack gap="lg">
      <PageHeader title="Streaming Genres" description="Manage streaming channel categories." />
