...
import { useCmsStore, type CmsItem } from "@modules/cms/entities/asset";
...
export function CmsListPage() {
  ...
  return (
    <Stack gap="lg">
      <PageHeader
        title="CMS Library — List"
        description="Tabular view of all CMS assets"
        actions={
          <AppButton
      ...
      <DataTable
        ...
        rowKey="id"
        loading={loading}
        emptyMessage="No CMS assets uploaded yet."
      />
