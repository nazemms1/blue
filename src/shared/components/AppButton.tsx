...
const variantStyles: Record<
  AppButtonVariant,
  {
    mantineVariant: ButtonProps["variant"];
    color?: string;
...
> = {
  primary: {
    ...
    styles: {
      root: {
        ...
        boxShadow:
          "0 2px 8px rgba(59, 130, 246, 0.25), 0 1px 2px rgba(0,0,0,0.08)",
        border: "none",
        fontWeight: 600,
        ...
        "&:hover:not([data-disabled])": {
          ...
          boxShadow:
            "0 4px 16px rgba(59, 130, 246, 0.35), 0 1px 4px rgba(0,0,0,0.1)",
  ...
  danger: {
    ...
    styles: {
      root: {
        boxShadow:
          "0 2px 8px rgba(239, 68, 68, 0.2), 0 1px 2px rgba(0,0,0,0.08)",
        fontWeight: 600,
        transition:
          "box-shadow 150ms ease, transform 150ms ease, filter 150ms ease",
        "&:hover:not([data-disabled])": {
